...
export default function DeclaracionPdfModal({
  ...
  // Open the declaration HTML in a popup window when content arrives.
  // winRef keeps the window without re-triggering this effect on setWin.
  useEffect(() => {
    if (!html || !open) return;
            ...
            <div className="p-4">
              {popupBlocked ? (
                <p className="text-sm text-amber-600">
                  El navegador bloqueó la ventana emergente. Permita popups para
                  este sitio y vuelva a intentar.
                </p>
              ) : win ? (
                <>
