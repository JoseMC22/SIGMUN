...
| Display columns | SP returns rows | Data loaded | Columns: idCarta, NroCarta, Ano, Dia, Mes, Ano(ye), Detalle, ROW |
...
| Header | Modal renders | Layout | Title "Generar Carta de Requerimiento" + close (x) button |
